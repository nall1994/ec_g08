...
{\color{incolor}In [{\color{incolor}2}]:} \PY{k}{def} \PY{n+nf}{Hash}\PY{p}{(}\PY{n}{s}\PY{p}{)}\PY{p}{:}
        ...
        \PY{c+c1}{\PYZsh{}def calculate\PYZus{}parity(blocks,number\PYZus{}blocks):}
        \PY{c+c1}{\PYZsh{}    str = format(0,\PYZsq{}128b\PYZsq{}) \PYZsh{} O número 0 é elemento neutro no XOR}
        \PY{c+c1}{\PYZsh{}    parity = int(str,2).to\PYZus{}bytes((len(str) + 7) // 8, \PYZsq{}big\PYZsq{})}
        \PY{c+c1}{\PYZsh{}    bytes\PYZus{}processed = 0}
        \PY{c+c1}{\PYZsh{}    while(bytes\PYZus{}processed \PYZlt{} (16*number\PYZus{}blocks)):}
        \PY{c+c1}{\PYZsh{}        max\PYZus{}bytes = bytes\PYZus{}processed + 16}
        \PY{c+c1}{\PYZsh{}        block\PYZus{}to\PYZus{}xor = blocks[bytes\PYZus{}processed:max\PYZus{}bytes]}
        \PY{c+c1}{\PYZsh{}        parity = bytes\PYZus{}xor(parity,block\PYZus{}to\PYZus{}xor)}
        \PY{c+c1}{\PYZsh{}        bytes\PYZus{}processed += 16}
        \PY{c+c1}{\PYZsh{}    return parity}
...
\emph{Diffie-Hellman}}{Geração dos parâmetros Diffie-Hellman}}\label{gerauxe7uxe3o-dos-paruxe2metros-diffie-hellman}}
    ...
    A próxima secção implementa a geração dos parâmetros necessários para a
...
agentes}\label{gerauxe7uxe3o-das-chaves-permanentes-dos-agentes}}
    ...
    Esta secção tem como objetivo gerar as chaves permanentes dos agentes
envolvidos na comunicação, tendo em conta que estas são conhecidas por
ambos, e serão aplicadas na assinatura digital das mensagens.
...
Recetor}\label{definiuxe7uxe3o-do-emissor-e-do-recetor}}
    ...
    Por fim definiu-se o comportamento de cada um dos agentes nesta sessão
...
agentes}\label{gerauxe7uxe3o-das-chaves-permanentes-dos-agentes}}
    ...
    Esta secção tem como objetivo gerar as chaves permanentes de ambos os
