    ...
    {\color{incolor}In [{\color{incolor}3}]:} \PY{k}{def} \PY{n+nf}{Emissor}\PY{p}{(}\PY{n}{connection}\PY{p}{)}\PY{p}{:}
                ...
                \PY{k}{try}\PY{p}{:}
                    ...
                    \PY{n}{derivation} \PY{o}{=} \PY{n}{PBKDF2HMAC}\PY{p}{(}
                            ...
                            \PY{n}{length} \PY{o}{=} \PY{l+m+mi}{96}\PY{p}{,}
                    ...
                    \PY{n}{mac\PYZus{}key} \PY{o}{=} \PY{n}{full\PYZus{}key}\PY{p}{[}\PY{l+m+mi}{32}\PY{p}{:}\PY{l+m+mi}{64}\PY{p}{]}
                    \PY{n}{mac\PYZus{}passwd\PYZus{}key} \PY{o}{=} \PY{n}{full\PYZus{}key}\PY{p}{[}\PY{l+m+mi}{64}\PY{p}{:}\PY{p}{]}
                    
                    \PY{c+c1}{\PYZsh{} Utilizar o AES com um dos modos que o torna numa stream cipher para cifrar o criptograma.}
                    \PY{n}{nonce} \PY{o}{=} \PY{n}{os}\PY{o}{.}\PY{n}{urandom}\PY{p}{(}\PY{l+m+mi}{16}\PY{p}{)}
                    \PY{n}{cipher} \PY{o}{=} \PY{n}{Cipher}\PY{p}{(}\PY{n}{algorithm} \PY{o}{=} \PY{n}{algorithms}\PY{o}{.}\PY{n}{AES}\PY{p}{(}\PY{n}{cript\PYZus{}key}\PY{p}{)}\PY{p}{,}\PY{n}{mode}\PY{o}{=} \PY{n}{modes}\PY{o}{.}\PY{n}{CTR}\PY{p}{(}\PY{n}{nonce}\PY{p}{)}\PY{p}{,}\PY{n}{backend} \PY{o}{=} \PY{n}{default\PYZus{}backend}\PY{p}{(}\PY{p}{)}\PY{p}{)}
                    ...
                    \PY{n}{hasher\PYZus{}passwd} \PY{o}{=} \PY{n}{hmac}\PY{o}{.}\PY{n}{HMAC}\PY{p}{(}\PY{n}{mac\PYZus{}passwd\PYZus{}key}\PY{p}{,}\PY{n}{hashes}\PY{o}{.}\PY{n}{SHA256}\PY{p}{(}\PY{p}{)}\PY{p}{,}\PY{n}{default\PYZus{}backend}\PY{p}{(}\PY{p}{)}\PY{p}{)}
                    ...
                    \PY{n}{obj} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{cryptogram}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{cryptogram}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{mac\PYZus{}code}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{hash\PYZus{}msg}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{pass\PYZus{}code}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{hash\PYZus{}pass}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{salt}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{con\PYZus{}salt}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{nonce}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{nonce}\PY{p}{\PYZcb{}}
...
\subsection{Definições Iniciais}\label{definiuxe7uxe3o-iniciais}}
